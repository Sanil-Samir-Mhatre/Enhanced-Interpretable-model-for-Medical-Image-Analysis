...
This guide will walk you through setting up the project environment and running the Streamlit web application on your local machine.

### Prerequisites

Before you begin, ensure you have the following installed on your system:
- **Git:** To clone the repository. You can download it from [git-scm.com](https://git-scm.com/).
- **Anaconda or Miniconda:** To manage the Python environment and dependencies. You can download it from the [Anaconda website](https://www.anaconda.com/products/distribution).

This project uses **Python 3.9**. The conda environment will handle the Python version for you.
...
1.  **Clone the repository:**
    ...
    ```shell
    git clone https://github.com/mafda/knee_OA_dl_app.git
    cd knee_OA_dl_app
    ```

2.  **Create and activate the Conda environment:**
    Use the `environment.yml` file to create a new conda environment with all the necessary dependencies.
...
3.  **Run the Streamlit Application:**
    With the `knee_dl_app` environment activated, you can start the web application.

    ```shell
    streamlit run app/app.py
    ```

    Your web browser should automatically open a new tab with the running application. If not, you can navigate to `http://localhost:8501`.
